  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background/50 backdrop-blur-sm hover:bg-accent/10 hover:text-accent hover:border-accent hover:scale-[1.02]",
        ...
        premium: "gradient-primary text-white hover:scale-[1.05] hover:shadow-xl transition-all duration-300",
        accent: "bg-accent text-accent-foreground hover:scale-[1.05] hover:glow-accent-strong transition-all duration-300 shadow-lg",
      },
      size: {
